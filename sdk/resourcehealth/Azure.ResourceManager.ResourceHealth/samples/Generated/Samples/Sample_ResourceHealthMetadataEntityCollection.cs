...
namespace Azure.ResourceManager.ResourceHealth.Samples
{
    public partial class Sample_ResourceHealthMetadataEntityCollection
    {
        ...
        {
            // Generated from example definition: specification/resourcehealth/resource-manager/Microsoft.ResourceHealth/stable/2024-02-01/examples/Metadata_List.json
        ...
        public async Task GetIfExists_GetMetadata()
        {
            ...
            // invoke the operation
            string name = "status";
            NullableResponse<ResourceHealthMetadataEntityResource> response = await collection.GetIfExistsAsync(name);
            ResourceHealthMetadataEntityResource result = response.HasValue ? response.Value : null;
